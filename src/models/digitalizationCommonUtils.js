// JavaScript code for digitalization Common Utils
import Advertisement from './Advertisement';
import  Post from './digitalization';
import { BASE_URL } from '../utils/constants';
import CaseStudyCommonUtils from './CaseStudyCommonUtils';
class DigitalizationCommonUtils {
    ...
    static async fetchPostCommonUtils() {
        try {
            console.log("cMAEKMS")
            const response = await fetch(`${BASE_URL}/digitalization/post_common_utils`);
            // console.log("sdfdsfs")
...
console.log("hb")
console.log(h_b)
        var post_common_utils = new DigitalizationCommonUtils( data.id,h_b,fp_posts,f_ad1,f_ad2,f_ad3,f_ad4,data.latest_updates1,data.latest_updates2,data.latest_updates3,data.latest_updates4,i_ad1,i_ad2,i_ad3,i_ad4)
...
export default DigitalizationCommonUtils;
