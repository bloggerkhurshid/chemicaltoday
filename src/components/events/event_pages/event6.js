...
import eventimage from '../../../assets/events/DSS Banner  (400 x 200 px).png'
const Event6Details = () => {
    return (
        <div className="event-details">
            <h1>Drug Safety Symposium 2024 - India Chapter </h1>
            <div className="event-header">
                <img src={eventimage} alt="Event Logo" className="event-image" />
                <div style={{fontFamily : 'Helvitica' , fontSize : 'medium'}}>
                <p>
                Drug Safety Symposium 2024 - India Chapter                              </p>
                    <p><strong>Location:</strong> Hotel Radisson Blu Mumbai International Airport</p>
                    <p><strong>Start:</strong> June 27th, 2024</p>
                    <p><strong>End:</strong> June 28th, 2024</p>
                    <p><strong>Contact:</strong>Shravan Nair</p>
                    <p><strong>Email:</strong> <a href="mailto: shravan@eminencemedia.in"> shravan@eminencemedia.in</a></p>
                    <p><strong>Phone:</strong>+91 7517 672 770</p>
                    <p><strong>Website:</strong> <a href="https://www.drugsafetysymposium.com/" target="_blank" rel="noopener noreferrer">https://www.drugsafetysymposium.com/</a></p>
                </div>
            </div>
            <div className="event-description">

                    <p>Following the resounding success of the Drug Safety Symposium 2024 in Dubai, we are thrilled to announce the much-awaited India Chapter of the Drug Safety Symposium 2024 on June 27th and 28th, 2024 at Radisson Blu Mumbai International Airport. 
Set against the backdrop of India's vibrant pharma landscape, this symposium promises to be a gathering of industry pioneers, regulatory experts, and thought leaders, all dedicated to advancing drug safety practices and shaping the future of healthcare. The symposium aims to bring together leading experts, industry professionals and thought leaders in the field of pharmacovigilance to discuss the latest advancements, regulatory changes, and innovative solutions driving the pharmaceutical industry forward. 
                                         </p>
