...
import eventimage from '../../../assets/events/400-x-200-GRPC-LOGO.jpg'
const Event1Details = () => {
    return (
        <div className="event-details">
            <h1>Global Refining & Petrochemicals Congress</h1>
            <h3 style={{color :'#bb2431'}}> 8th Edition 2024</h3>
            <div className="event-header">
                ...
                <div style={{fontFamily : 'Helvitica' , fontSize : 'medium'}}>
                    ...
                    <p><strong>End:</strong> 5:30 PM, 28th June 2024</p>
                    <p><strong>Contact:</strong> Mr. Sunny Mehta</p>
                    <p><strong>Email:</strong> <a href="mailto:Sunny@itenmedia.in">Sunny@itenmedia.in</a></p>
                    <p><strong>Phone:</strong> 01143013474, 09711433168</p>
                    <p><strong>Website:</strong> <a href="http://www.refpet.com" target="_blank" rel="noopener noreferrer">www.refpet.com</a></p>
                </div>
            </div>
            ...
            <p>
                    ...
                    <p>
                     ...
                     The flagship industry forum is dedicated to facilitating the global downstream industry's transition to an agile, lean & sustainable future.
                     </p>
